...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='geopose', help='chooses which model to use. [geopose | matching]')
        parser.add_argument('--net', type=str, default='vote', help='chooses which network to use. [vote | dcp | refine]')

        parser.add_argument('--point_emb', type=str, default='dgcnn', help='option: dgcnn | pointnet')
        parser.add_argument('--input_nc', type=int, default=3, help='# of input image channels: 3 for RGB and 1 for grayscale')
        parser.add_argument('--norm', type=str, default='instance', help='instance normalization or batch normalization [instance | batch | none]')
        parser.add_argument('--init_type', type=str, default='normal', help='network initialization [normal | xavier | kaiming | orthogonal]')
        parser.add_argument('--run_refine_net', action='store_true', help='if specified, train RefiningNet, otherwise only run MatchingNet')
        ...
        parser.add_argument('--num_points', type=int, default=500, help='number of points sampled from point clouds')
        parser.add_argument('--hit_ratio_thresh', type=float, default=0.01, help='hit ratio threshold')


        # parser.add_argument('--min_depth', type=float, default=1e-2, help='capped minimum depth.')
        # parser.add_argument('--max_depth', type=float, default=5, help='capped maximum depth.')
